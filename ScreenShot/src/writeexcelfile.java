...
public class writeexcelfile {
	public static  void main(String args[]) throws IOException {
		...
		File file =    new File("E:\\DataSets\\TestData1.xlsx");
		...
		for(int i=1;i<=rowCount;i++) {
			...
			double imob = sheet.getRow(i).getCell(4).getNumericCellValue();
			BigDecimal bd = new BigDecimal(imob);
			mobile.sendKeys(String.valueOf(bd));
			...
			FileOutputStream outputStream = new FileOutputStream("E:\\DataSets\\TestData1.xlsx");
